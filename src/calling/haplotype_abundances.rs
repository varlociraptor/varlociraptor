...
impl Caller {
    ...
    pub(crate) fn estimate_parameters(self, seqnames: Vec<String>) -> Result<()> {
        let hdf5 = &self.hdf5_reader;
        let ids = hdf5
            .dataset("aux/ids")?
            .read_1d::<hdf5::types::FixedAscii<255>>()?;
